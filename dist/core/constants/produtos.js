...
const produtos = [
    ...
    },
    {
        ...
        descricao: 'O Lenovo Legion Y540 é um notebook gamer de alta performance com design elegante.',
        marca: 'Lenovo',
    ...
    },
    {
        ...
        descricao: 'O HP Pavilion é um notebook gamer com desempenho sólido e design moderno, perfeito para jogadores que buscam custo-benefício.',
        marca: 'HP',
    ...
    },
    {
        ...
        descricao: 'O MSI GL65 Leopard oferece um desempenho superior com design agressivo e teclado RGB personalizável.',
        marca: 'MSI',
    ...
    },
    {
        ...
        descricao: 'O Razer Blade 15 é um notebook gamer premium com design ultrafino e hardware de ponta.',
        marca: 'Razer',
    ...
    },
    {
        ...
        descricao: 'O Alienware m15 é um notebook gamer de alto desempenho com design futurista e recursos avançados.',
        marca: 'Dell',
        modelo: 'm15 R3',
    ...
    },
    {
        ...
        descricao: 'Desfrute de velocidades supersônicas com 8 núcleos e 16 threads de processamento, prontos para enfrentar os títulos mais desafiadores. Frequência base de 3,0GHz e boost dinâmico de até 4,1GHz para eliminar qualquer engasgo.',
        marca: 'AMD',
    ...
    },
    {
        ...
        descricao: 'O Intel Core i9-13900K é o processador ideal para gamers e profissionais que precisam de desempenho extremo. Equipado com 24 núcleos e 32 threads, alcança frequências de até 5,8 GHz em modo turbo, oferecendo desempenho inigualável.',
        marca: 'Intel',
    ...
    },
    {
        ...
        descricao: 'O processador AMD Ryzen 9 7950X3D redefine o desempenho de jogos e produtividade, com 16 núcleos e 32 threads e cache total de 128MB. Frequência de boost de até 5,7 GHz, ideal para cargas intensas de trabalho e multitarefa.',
        marca: 'AMD',
    ...
    },
    {
        ...
        descricao: 'O Razer BlackWidow V3 é equipado com switches mecânicos Razer Green para uma resposta tátil precisa e feedback auditivo satisfatório. Possui iluminação RGB Razer Chroma e estrutura em alumínio para maior durabilidade.',
        marca: 'Razer',
    ...
    },
    {
        ...
        descricao: 'Com switches Cherry MX Red, o Corsair K70 RGB MK.2 oferece resposta linear e silenciosa. Construído em alumínio escovado, ideal para sessões longas de gameplay, e com iluminação RGB dinâmica.',
        marca: 'Corsair',
    ...
    },
    {
        ...
        descricao: 'O Redragon Draconic K530 é um teclado mecânico compacto, sem fio, projetado para máxima portabilidade e desempenho. Equipado com switches Outemu Brown, ideal para quem busca um equilíbrio entre feedback tátil e silêncio, além de conectividade Bluetooth.',
        marca: 'Redragon',
        modelo: 'K530-RGB',
    ...
    },
    {
        ...
        descricao: 'O Logitech G403 Hero é equipado com o sensor HERO 25K, oferecendo precisão máxima com até 25.600 DPI ajustáveis. Design ergonômico, estrutura leve e peso ajustável, ideal para quem busca conforto e alto desempenho em jogos.',
        marca: 'Logitech',
        modelo: '910-005631',
    ...
    },
    {
        ...
        descricao: 'O Razer DeathAdder V2 possui o sensor ótico Focus+ de 20.000 DPI, com switches ópticos para cliques mais rápidos e durabilidade de até 70 milhões de cliques. Design ergonômico e leve, com cabo SpeedFlex para movimentos sem arrasto.',
        marca: 'Razer',
    ...
    },
    {
        ...
        descricao: 'O HyperX Pulsefire FPS Pro é ideal para jogadores que buscam precisão e conforto. Equipado com o sensor Pixart 3389 de até 16.000 DPI e botões Omron com alta durabilidade. Iluminação RGB personalizável e design ergonômico.',
        marca: 'HyperX',
        modelo: 'HX-MC003B',
    ...
    },
    {
        ...
        descricao: 'O HyperX Cloud II é um headset projetado para máximo conforto e qualidade de som. Possui drivers de 53mm e som surround virtual 7.1, ideal para gamers que buscam imersão completa em jogos.',
        marca: 'HyperX',
        modelo: 'KHX-HSCP-RD',
    ...
    },
    {
        ...
        descricao: 'O Razer Kraken X é um headset ultraleve com som surround 7.1 e almofadas em espuma com memória para máximo conforto. Microfone cardioide e estrutura reforçada para durabilidade.',
        marca: 'Razer',
    ...
    },
    {
        ...
        descricao: 'O Samsung Odyssey G7 possui taxa de atualização de 240Hz e tempo de resposta de 1ms. Com painel curvo QHD e tecnologia G-Sync, é ideal para gamers que buscam desempenho e imersão.',
        marca: 'Samsung',
    ...
    },
    {
        ...
        descricao: 'O LG UltraGear 34" é um monitor ultra-wide com resolução WQHD (3440x1440), taxa de atualização de 160Hz e suporte a G-Sync. Ideal para quem busca um monitor para jogos e produtividade.',
        marca: 'LG',
        modelo: '34GN850-B',
    ...
    },
    {
        ...
        descricao: 'A RTX 3060 Ventus 2X MSI é equipada com 12GB GDDR6, oferecendo desempenho de última geração para jogos 4K e Ray Tracing. Possui suporte a DLSS e tecnologias avançadas da NVIDIA para máxima performance.',
        marca: 'MSI',
    ...
    },
    {
        ...
        descricao: 'A ROG Strix Z590-E é uma placa-mãe premium para processadores Intel de 11ª geração, com suporte a overclock, Wi-Fi 6E integrado e iluminação RGB ASUS Aura Sync.',
        marca: 'ASUS',
    ...
    },
    {
        ...
        descricao: 'A MAG B550 Tomahawk é uma placa-mãe robusta para CPUs AMD Ryzen, oferecendo suporte a PCIe 4.0 e design térmico otimizado com dissipadores estendidos para maior estabilidade.',
        marca: 'MSI',
    ...
    },
    {
        ...
        descricao: 'O kit Corsair Vengeance RGB Pro oferece desempenho de alto nível para jogadores e criadores de conteúdo, com 16GB de capacidade, frequência de 3200MHz e iluminação RGB dinâmica.',
        marca: 'Corsair',
    ...
    },
    {
        ...
        descricao: 'A Kingston Fury Beast é projetada para usuários que necessitam de capacidade extra. Com 32GB e frequência de 3200MHz, é ideal para multitarefa avançada e jogos pesados, mantendo baixa latência.',
        marca: 'Kingston',
    ...
    },
    {
        ...
        descricao: 'O PlayStation 5 Slim oferece gráficos de nova geração com suporte a Ray Tracing, tempos de carregamento rápidos com seu SSD customizado e jogos exclusivos que definem a plataforma.',
        marca: 'Sony',
        modelo: 'CFI-1015A',
